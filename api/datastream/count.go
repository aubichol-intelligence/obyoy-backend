...
type countHandler struct {
	countByStatusReader datastream.CountReader
}
...
func (read *countHandler) handleCountDatastream(
	w http.ResponseWriter,
	r *http.Request,
) {
...
func (read *countHandler) ServeHTTP(
	...
	read.handleCountDatastream(w, r)
}
...
type CountParams struct {
	dig.In
	CountByStatus datastream.CountReader
...
func CountRoute(
	...
	return &routeutils.Route{
		...
		Pattern: apipattern.DatastreamCount,
