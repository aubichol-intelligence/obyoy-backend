...
type listHandler struct {
	lister parallelsentence.Lister
}

func (ch *listHandler) decodeBody(
	body io.ReadCloser,
) (
	parallelsentence dto.ListReq,
	err error,
) {
...
func (list *listHandler) askController(
	...
	resp, err = list.lister.List(&listReq, listReq.Skip, listReq.Limit)
	return
}
...
func ListRoute(
	...
	return &routeutils.Route{
		...
		Pattern: apipattern.ParallelsentenceList,
