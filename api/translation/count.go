...
type countHandler struct {
	countByStatusReader translation.CountReader
}
...
func (read *countHandler) handleCountTranslation(
	w http.ResponseWriter,
	r *http.Request,
) {
...
func (read *countHandler) ServeHTTP(
	...
	read.handleCountTranslation(w, r)
}
...
type CountParams struct {
	dig.In
	CountByStatus translation.CountReader
...
func CountRoute(
	...
	return &routeutils.Route{
		...
		Pattern: apipattern.TranslationCount,
